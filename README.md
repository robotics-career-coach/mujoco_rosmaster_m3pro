...
Each wheel is a hub cylinder surrounded by 12 passive, free-spinning roller
bodies (sphere geoms on undriven hinge joints) arranged around its rim, rather
than a single geom with hand-tuned directional friction — this is what
produces smooth holonomic motion in MuJoCo (generated by
`m3pro_description/scripts/generate_mecanum_rollers.py`). See
